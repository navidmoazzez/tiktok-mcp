...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/tiktok-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/tiktok-$version.mcpb"

echo
echo "Built desktop-extension/tiktok-$version.mcpb"
